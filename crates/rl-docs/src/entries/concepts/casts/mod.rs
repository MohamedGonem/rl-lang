...
pub static CASTING: ConceptEntry = ConceptEntry {
    ...
    descriptions: &[
        ...
        DescriptionEntry {
            kind: DescriptionKind::Syntax,
            title: Some("numeric suffix sugar"),
            description: "instead of `value as type`, you can write `value_type` directly by appending an underscore and the type suffix to the literal. This is shorter and avoids the `as` cast entirely",
            examples: &[
                "println(10_u8)       // 10   (byte)",
                "println(10_i8)       // 10   (signed byte)",
                "println(1000_u16)    // 1000 (big byte)",
                "println(1000_i16)    // 1000 (big signed byte)",
                "println(100_i32)     // 100  (small int)",
                "println(100_u32)     // 100  (small uint)",
                "println(3.14_f32)    // 3.14 (small float)",
                "println(100_i64)     // 100  (int)",
                "println(100_u64)     // 100  (uint)",
                "println(3.14_f64)    // 3.14 (float)",
            ],
            expected_output: &["10", "10", "1000", "1000", "100", "100", "3.14", "100", "100", "3.14"],
        },
        DescriptionEntry {
            kind: DescriptionKind::Explanation,
            title: Some("suffix vs as cast"),
            description: "suffix sugar and `as` casts produce identical results - suffixes are just syntactic sugar. Use whichever reads better in context",
            examples: &[
                "dec byte a = 10_u8      // suffix",
                "dec byte b = 10 as byte  // as cast",
                "println(a == b)          // true",
            ],
