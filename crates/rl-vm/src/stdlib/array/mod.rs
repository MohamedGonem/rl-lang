...
//!
//! All functions operate on [`VmValue::Arr`] and return errors for non-array inputs.
//! Higher-order functions (`map`, `filter`, `reduce`, etc.) require a callable
//! [`VmValue`] (`Function`, `Native`, or `Closure`).
...
pub fn module() -> Module {
    Module::new("array")
        ...
        .with_function("arr_zip", arr_zip::std_arr_zip)
}
