...
fn set_attr(attr: Attribute, name: &str) -> VmValue {
...
pub fn std_term_bold(_: &mut Vm) -> VmValue {
    set_attr(Attribute::Bold, "term_bold")
}

pub fn std_term_dim(_: &mut Vm) -> VmValue {
    set_attr(Attribute::Dim, "term_dim")
}

pub fn std_term_italic(_: &mut Vm) -> VmValue {
    set_attr(Attribute::Italic, "term_italic")
}

pub fn std_term_underline(_: &mut Vm) -> VmValue {
    set_attr(Attribute::Underlined, "term_underline")
}

pub fn std_term_blink(_: &mut Vm) -> VmValue {
    set_attr(Attribute::SlowBlink, "term_blink")
}

pub fn std_term_reverse(_: &mut Vm) -> VmValue {
    set_attr(Attribute::Reverse, "term_reverse")
}

pub fn std_term_crossed_out(_: &mut Vm) -> VmValue {
    set_attr(Attribute::CrossedOut, "term_crossed_out")
}

pub fn std_term_reset_attr(_: &mut Vm) -> VmValue {
