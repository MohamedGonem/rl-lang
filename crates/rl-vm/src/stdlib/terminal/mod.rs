...
pub fn module() -> Module {
    Module::new("term")
        ...
        // save / restore
        .with_function("term_save_cursor", save_cursor::func)
        .with_function("term_restore_cursor", restore_cursor::func)
        // show / hide
        .with_function("term_hide_cursor", hide_cursor::func)
        .with_function("term_show_cursor", show_cursor::func)
        // size / title
        .with_function("term_get_size", size::std_term_get_size)
        .with_function("term_set_size", size::std_term_set_size)
        .with_function("term_set_title", set_title::func)
        // scroll
        .with_function("term_scroll_up", scroll::std_term_scroll_up)
        .with_function("term_scroll_down", scroll::std_term_scroll_down)
        // output
        .with_function("term_print", print::func)
        .with_function("term_flush", flush::func)
        // rgb color
        .with_function("term_set_fg", set_fg::func)
        .with_function("term_set_bg", set_bg::func)
        .with_function("term_reset_color", reset_color::func)
        // named color
        ...
        // line wrap
        .with_function("term_enable_wrap", wrap::std_term_enable_wrap)
        .with_function("term_disable_wrap", wrap::std_term_disable_wrap)
        // synchronized output
        .with_function("term_begin_sync", sync_output::std_term_begin_sync)
        .with_function("term_end_sync", sync_output::std_term_end_sync)
        // mouse
        .with_function("term_enable_mouse", mouse::std_term_enable_mouse)
        .with_function("term_disable_mouse", mouse::std_term_disable_mouse)
        // input
        .with_function("term_read_key", read_key::func)
        .with_function("term_poll", poll::func)
}
