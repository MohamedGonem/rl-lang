...
impl Parser {
    ...
    pub fn check(&self, token_type: &TokenType) -> bool {
        ...
        match (token_type, &current) {
            ...
            (TokenType::SignedByteLiteral(_), TokenType::SignedByteLiteral(_)) => true,
            (TokenType::BigByteLiteral(_), TokenType::BigByteLiteral(_)) => true,
            (TokenType::BigSignedByteLiteral(_), TokenType::BigSignedByteLiteral(_)) => true,
            (TokenType::SmallIntLiteral(_), TokenType::SmallIntLiteral(_)) => true,
            (TokenType::SmallUIntLiteral(_), TokenType::SmallUIntLiteral(_)) => true,
            (TokenType::SmallFloatLiteral(_), TokenType::SmallFloatLiteral(_)) => true,
            (TokenType::UIntLiteral(_), TokenType::UIntLiteral(_)) => true,
