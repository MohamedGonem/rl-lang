...
int main(int argc, char **argv) {
    ...
    rl_println(rl_ok((((int64_t)3) < ((int64_t)7) ? ((int64_t)3) : ((int64_t)7))));
    rl_println(rl_math_abs(rl_ok((int64_t)-42)));
    ...
    rl_println(rl_math_pow(rl_ok((double)2), rl_ok((double)10)));
    ...
    rl_io_write_file(rl_str_literal("/tmp/rl_test_io/test.txt", 24), rl_str_literal("hello world", 11));
    rl_println(rl_io_read_file(rl_str_literal("/tmp/rl_test_io/test.txt", 24)));
    rl_io_append_file(rl_str_literal("/tmp/rl_test_io/test.txt", 24), rl_str_literal(" appended", 9));
    rl_println(rl_io_read_file(rl_str_literal("/tmp/rl_test_io/test.txt", 24)));
    rl_println(rl_io_read_lines(rl_str_literal("/tmp/rl_test_io/test.txt", 24)));
