...
println(std::path::path_exists("/tmp"))
...
println(std::path::path_is_dir("/tmp"))
println(std::path::path_is_file("/etc/hostname"))
...
std::io::write_file("/tmp/rl_test_io/test.txt", "hello world")
println(std::io::read_file("/tmp/rl_test_io/test.txt"))
std::io::append_file("/tmp/rl_test_io/test.txt", " appended")
println(std::io::read_file("/tmp/rl_test_io/test.txt"))
println(std::io::read_lines("/tmp/rl_test_io/test.txt"))
